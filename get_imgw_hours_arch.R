...
# zrodlo danych
base_url <- "https://dane.imgw.pl/data/dane_pomiarowo_obserwacyjne/dane_meteorologiczne/terminowe/klimat/"
...
get_folders_list <- function(folder) {
   ...
   hrefs <- hrefs[hrefs != "/data/dane_pomiarowo_obserwacyjne/dane_meteorologiczne/terminowe/"]
   ...
   for(k in seq_along(pliki)) {
      ...
      df <- read_csv(paste0("tempdir/", pliki[k]),
                     col_names = c("Kod_stacji", "Nazwa_stacji",
                                   ...
                                   "TempZw", "StatusTempZw",
                                   "Lod", "Wentylacja",
                                   "Wilgotnosc", "StatusWilgotnosc",
                                   "KierWiatru", "StatusKierWiatru",
                                   "PredkoscWiatru", "StatusPredkoscWiatru",
                                   "Zachmurzenie", "StatusZachmurzenie",
                                   "Widzialnosc", "StatusWidzialnosc"),
                     col_types = "cciiiidcdcccicccicicic")
